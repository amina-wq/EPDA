...
<head>
    <meta charset="UTF-8">
    <title>Course Recovery System - Login</title>
</head>
<body style="background-color: #f4f7f6; font-family: Arial, sans-serif;">
    ...
    <div class="login-container" style="max-width: 450px; margin: 80px auto; padding: 30px; background: white; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); border: 1px solid #ddd;">
        ...
        <% if ("invalid".equals(request.getParameter("error"))) { %>
            <p style="color: #d9534f; background: #f2dede; padding: 10px; border-radius: 4px; border: 1px solid #ebccd1;">Invalid username or password.</p>
        <% } %>
        ...
        <% if ("reset_success".equals(request.getParameter("message"))) { %>
        ...
        <form action="${pageContext.request.contextPath}/LoginServlet" method="POST">
            ...
            <div style="text-align: center;">
                <a href="resetPassword.jsp" style="color: #0056b3; text-decoration: none; font-size: 14px;">Forgot your password? Reset it here</a>
            </div>
        </form>
    </div>
